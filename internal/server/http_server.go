...
func (s *HttpServer) characterSettings(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == http.MethodPost {
		...
		cfg.Game.A3Temples.DoRuinedTemple = r.Form.Has("gameA3TemplesRuinedTemple")
		cfg.Game.A3Temples.OnlyKillBattleMaidSarina = r.Form.Has("gameA3TemplesBattlemaidSarinaOnly")
		cfg.Game.A3Temples.DoDisusedFane = r.Form.Has("gameA3TemplesDisusedFane")
		cfg.Game.A3Temples.DoForgottenTemple = r.Form.Has("gameA3TemplesForgottenTemple")
		cfg.Game.A3Temples.DoForgottenReliquary = r.Form.Has("gameA3TemplesForgottenReliquary")
		cfg.Game.A3Temples.DoDisusedReliquary = r.Form.Has("gameA3TemplesDisusedReliquary")
		cfg.Game.A3Temples.DoRuinedFane = r.Form.Has("gameA3TemplesRuinedFane")
		//cfg.Game.A3Temples.OpenChests = r.Form.Has("gameA3TemplesOpenChests")
		cfg.Game.A3Temples.FocusOnElitePacks = r.Form.Has("gameA3TemplesFocusOnElitePacks")
