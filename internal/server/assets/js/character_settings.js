...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateCharacterOptions() {
        ...
        } else if (selectedClass === 'nova' || selectedClass === 'lightsorc'|| selectedClass === 'frostnovaorb') {
    ...
    document.getElementById('gameDifficulty').addEventListener('change', function() {
        if (characterClassSelect.value === 'nova' || characterClassSelect.value === 'lightsorc' || selectedClass === 'frostnovaorb') {
            updateNovaSorceressOptions();
        }
    });
